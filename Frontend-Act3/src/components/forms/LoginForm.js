...
export default function LoginForm({ navigation }) {
  ...
  const handleLogin = async (values) => {
    try {
      const url = "http://192.168.1.14:8000/api/v1/login";
  ...
  return (
    ...
    >
      {({
        ...
        return (
          <View style={{ flex: 1, alignItems: "center", paddingHorizontal: 20, paddingTop: 150}}>
            <Text variant="displayMedium" style={{ color: "#800080", fontWeight: "bold", }}>Login</Text>
            <TextInput
              mode="outlined"
              placeholder="Email"
              label="Email"
